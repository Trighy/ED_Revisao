...
class TestListaSequencialSimples {
    ...
    void obtem_invalido() throws InterruptedException, IOException {
        ...
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.obtem(0);});
        q.adiciona(Integer.valueOf(10));

        // acessar uma posição negativa
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.obtem(-1);});
        // acessar uma posição igual ao comprimento da lista
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.obtem(1);});
        // acessar uma posição maior que comprimento da lista
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.obtem(7);});
    }
    ...
    void remove_invalido() throws InterruptedException, IOException {
        ...
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.remove(0);});
        q.adiciona(Integer.valueOf(10));

        // acessar uma posição negativa
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.remove(-1);});
        // remover da posição igual ao comprimento
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.remove(1);});
        // remover da posição maior que comprimento
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.remove(7);});
    }
    ...
    void substitui_invalido() throws InterruptedException, IOException {
        ...
        // remover de lista vazia
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.substitui(0, 45);});
        q.adiciona(Integer.valueOf(10));

        // acessar uma posição negativa
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.substitui(-1, 44);});
        // remover da posição igual ao comprimento
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.substitui(1, 45);});
        // remover da posição maior que comprimento
        Assertions.assertThrows(IndexOutOfBoundsException.class, () -> {q.substitui(7, 44);});
    }
